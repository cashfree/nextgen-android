...
class DropCheckoutActivity : ComponentActivity(), CFCheckoutResponseCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            LaunchedEffect(key1 = context) {
                CFPaymentGatewayService.getInstance().setCheckoutCallback(this@DropCheckoutActivity)
            }
            try {
